...
class JewishCalendar(JewishDate):
    ...
    def parshah(self):
        if self.day_of_week != 7:
            return self.PARSHA.NONE.name
        else:
            year_type = self._parsha_year_type()
            rosh_hashana_day_of_week = self.day_of_week - (self.day_number_of_jewish_year() - 1) % 7
            rosh_hashana_day_of_week = rosh_hashana_day_of_week if rosh_hashana_day_of_week > 0 else rosh_hashana_day_of_week + 7
            day = rosh_hashana_day_of_week + self.day_number_of_jewish_year()

            return self.parsha_list[year_type][day//7] if year_type >= 0 else self.PARSHA.NONE.name
    ...
    def _parsha_year_type(self):
        rosh_hashana_day_of_week = self.day_of_week - (self.day_number_of_jewish_year() - 1) % 7
        rosh_hashana_day_of_week = rosh_hashana_day_of_week if rosh_hashana_day_of_week > 0 else rosh_hashana_day_of_week + 7

        if self.is_jewish_leap_year():
            if rosh_hashana_day_of_week == 2:
                if self.is_kislev_short():
                    return 14 if self.in_israel else 6
                if self.is_cheshvan_long():
                    return 15 if self.in_israel else 7
            elif rosh_hashana_day_of_week == 3:
                return 15 if self.in_israel else 7
            elif rosh_hashana_day_of_week == 5:
                if self.is_kislev_short():
                    return 8
                if self.is_cheshvan_long():
                    return 9
            elif rosh_hashana_day_of_week == 7:
                if self.is_kislev_short():
                    return 10
                if self.is_cheshvan_long():
                    return 16 if self.in_israel else 11
        else:
            if rosh_hashana_day_of_week == 2:
                if self.is_kislev_short():
                    return 0
                if self.is_cheshvan_long():
                    return 12 if self.in_israel else 1
            elif rosh_hashana_day_of_week == 3:
                return 12 if self.in_israel else 1
            elif rosh_hashana_day_of_week == 5:
                if self.is_cheshvan_long():
                    return 3
                if not self.is_kislev_short():
                    return 13 if self.in_israel else 2
            elif rosh_hashana_day_of_week == 7:
                if self.is_kislev_short():
                    return 4
                if self.is_cheshvan_long():
    ...
    parsha_list = [
        [PARSHA.NONE.name, PARSHA.VAYEILECH.name, PARSHA.HAAZINU.name, PARSHA.NONE.name, PARSHA.BERESHIS.name,
         PARSHA.NOACH.name, PARSHA.LECH_LECHA.name, PARSHA.VAYERA.name, PARSHA.CHAYEI_SARA.name, PARSHA.TOLDOS.name,
         PARSHA.VAYETZEI.name, PARSHA.VAYISHLACH.name, PARSHA.VAYESHEV.name, PARSHA.MIKETZ.name, PARSHA.VAYIGASH.name,
         PARSHA.VAYECHI.name, PARSHA.SHEMOS.name, PARSHA.VAERA.name, PARSHA.BO.name, PARSHA.BESHALACH.name,
         PARSHA.YISRO.name, PARSHA.MISHPATIM.name, PARSHA.TERUMAH.name, PARSHA.TETZAVEH.name, PARSHA.KI_SISA.name,
         PARSHA.VAYAKHEL_PEKUDEI.name, PARSHA.VAYIKRA.name, PARSHA.TZAV.name, PARSHA.NONE.name, PARSHA.SHMINI.name,
         PARSHA.TAZRIA_METZORA.name, PARSHA.ACHREI_MOS_KEDOSHIM.name, PARSHA.EMOR.name, PARSHA.BEHAR_BECHUKOSAI.name,
         PARSHA.BAMIDBAR.name, PARSHA.NASSO.name, PARSHA.BEHAALOSCHA.name, PARSHA.SHLACH.name, PARSHA.KORACH.name,
         PARSHA.CHUKAS.name, PARSHA.BALAK.name, PARSHA.PINCHAS.name, PARSHA.MATOS_MASEI.name, PARSHA.DEVARIM.name,
         PARSHA.VAESCHANAN.name, PARSHA.EIKEV.name, PARSHA.REEH.name, PARSHA.SHOFTIM.name, PARSHA.KI_SEITZEI.name,
         PARSHA.KI_SAVO.name, PARSHA.NITZAVIM_VAYEILECH.name],
        [PARSHA.NONE.name, PARSHA.VAYEILECH.name, PARSHA.HAAZINU.name, PARSHA.NONE.name, PARSHA.BERESHIS.name,
         PARSHA.NOACH.name, PARSHA.LECH_LECHA.name, PARSHA.VAYERA.name, PARSHA.CHAYEI_SARA.name, PARSHA.TOLDOS.name,
         PARSHA.VAYETZEI.name, PARSHA.VAYISHLACH.name, PARSHA.VAYESHEV.name, PARSHA.MIKETZ.name, PARSHA.VAYIGASH.name,
         PARSHA.VAYECHI.name, PARSHA.SHEMOS.name, PARSHA.VAERA.name, PARSHA.BO.name, PARSHA.BESHALACH.name,
         ...
         PARSHA.VAYAKHEL_PEKUDEI.name, PARSHA.VAYIKRA.name, PARSHA.TZAV.name, PARSHA.NONE.name, PARSHA.SHMINI.name,
         PARSHA.TAZRIA_METZORA.name, PARSHA.ACHREI_MOS_KEDOSHIM.name, PARSHA.EMOR.name, PARSHA.BEHAR_BECHUKOSAI.name,
         PARSHA.BAMIDBAR.name, PARSHA.NONE.name, PARSHA.NASSO.name, PARSHA.BEHAALOSCHA.name, PARSHA.SHLACH.name,
         PARSHA.KORACH.name, PARSHA.CHUKAS_BALAK.name, PARSHA.PINCHAS.name, PARSHA.MATOS_MASEI.name,
         PARSHA.DEVARIM.name, PARSHA.VAESCHANAN.name, PARSHA.EIKEV.name, PARSHA.REEH.name, PARSHA.SHOFTIM.name,
         PARSHA.KI_SEITZEI.name, PARSHA.KI_SAVO.name, PARSHA.NITZAVIM_VAYEILECH.name],
        [PARSHA.NONE.name, PARSHA.HAAZINU.name, PARSHA.NONE.name, PARSHA.NONE.name, PARSHA.BERESHIS.name,
         PARSHA.NOACH.name, PARSHA.LECH_LECHA.name, PARSHA.VAYERA.name, PARSHA.CHAYEI_SARA.name, PARSHA.TOLDOS.name,
         PARSHA.VAYETZEI.name, PARSHA.VAYISHLACH.name, PARSHA.VAYESHEV.name, PARSHA.MIKETZ.name, PARSHA.VAYIGASH.name,
         PARSHA.VAYECHI.name, PARSHA.SHEMOS.name, PARSHA.VAERA.name, PARSHA.BO.name, PARSHA.BESHALACH.name,
         PARSHA.YISRO.name, PARSHA.MISHPATIM.name, PARSHA.TERUMAH.name, PARSHA.TETZAVEH.name, PARSHA.KI_SISA.name,
         PARSHA.VAYAKHEL_PEKUDEI.name, PARSHA.VAYIKRA.name, PARSHA.TZAV.name, PARSHA.NONE.name, PARSHA.NONE.name,
         PARSHA.SHMINI.name, PARSHA.TAZRIA_METZORA.name, PARSHA.ACHREI_MOS_KEDOSHIM.name, PARSHA.EMOR.name,
         PARSHA.BEHAR_BECHUKOSAI.name, PARSHA.BAMIDBAR.name, PARSHA.NASSO.name, PARSHA.BEHAALOSCHA.name,
         PARSHA.SHLACH.name, PARSHA.KORACH.name, PARSHA.CHUKAS.name, PARSHA.BALAK.name, PARSHA.PINCHAS.name,
         PARSHA.MATOS_MASEI.name, PARSHA.DEVARIM.name, PARSHA.VAESCHANAN.name, PARSHA.EIKEV.name, PARSHA.REEH.name,
         PARSHA.SHOFTIM.name, PARSHA.KI_SEITZEI.name, PARSHA.KI_SAVO.name, PARSHA.NITZAVIM.name],
        [PARSHA.NONE.name, PARSHA.HAAZINU.name, PARSHA.NONE.name, PARSHA.NONE.name, PARSHA.BERESHIS.name,
         PARSHA.NOACH.name, PARSHA.LECH_LECHA.name, PARSHA.VAYERA.name, PARSHA.CHAYEI_SARA.name, PARSHA.TOLDOS.name,
         PARSHA.VAYETZEI.name, PARSHA.VAYISHLACH.name, PARSHA.VAYESHEV.name, PARSHA.MIKETZ.name, PARSHA.VAYIGASH.name,
         PARSHA.VAYECHI.name, PARSHA.SHEMOS.name, PARSHA.VAERA.name, PARSHA.BO.name, PARSHA.BESHALACH.name,
         PARSHA.YISRO.name, PARSHA.MISHPATIM.name, PARSHA.TERUMAH.name, PARSHA.TETZAVEH.name, PARSHA.KI_SISA.name,
         PARSHA.VAYAKHEL.name, PARSHA.PEKUDEI.name, PARSHA.VAYIKRA.name, PARSHA.TZAV.name, PARSHA.NONE.name,
         PARSHA.SHMINI.name, PARSHA.TAZRIA_METZORA.name, PARSHA.ACHREI_MOS_KEDOSHIM.name, PARSHA.EMOR.name,
         PARSHA.BEHAR_BECHUKOSAI.name, PARSHA.BAMIDBAR.name, PARSHA.NASSO.name, PARSHA.BEHAALOSCHA.name,
         PARSHA.SHLACH.name, PARSHA.KORACH.name, PARSHA.CHUKAS.name, PARSHA.BALAK.name, PARSHA.PINCHAS.name,
         PARSHA.MATOS_MASEI.name, PARSHA.DEVARIM.name, PARSHA.VAESCHANAN.name, PARSHA.EIKEV.name, PARSHA.REEH.name,
         PARSHA.SHOFTIM.name, PARSHA.KI_SEITZEI.name, PARSHA.KI_SAVO.name, PARSHA.NITZAVIM.name],
        [PARSHA.NONE.name, PARSHA.NONE.name, PARSHA.HAAZINU.name, PARSHA.NONE.name, PARSHA.NONE.name,
         PARSHA.BERESHIS.name, PARSHA.NOACH.name, PARSHA.LECH_LECHA.name, PARSHA.VAYERA.name, PARSHA.CHAYEI_SARA.name,
         PARSHA.TOLDOS.name, PARSHA.VAYETZEI.name, PARSHA.VAYISHLACH.name, PARSHA.VAYESHEV.name, PARSHA.MIKETZ.name,
         PARSHA.VAYIGASH.name, PARSHA.VAYECHI.name, PARSHA.SHEMOS.name, PARSHA.VAERA.name, PARSHA.BO.name,
         PARSHA.BESHALACH.name, PARSHA.YISRO.name, PARSHA.MISHPATIM.name, PARSHA.TERUMAH.name, PARSHA.TETZAVEH.name,
         PARSHA.KI_SISA.name, PARSHA.VAYAKHEL_PEKUDEI.name, PARSHA.VAYIKRA.name, PARSHA.TZAV.name, PARSHA.NONE.name,
         PARSHA.SHMINI.name, PARSHA.TAZRIA_METZORA.name, PARSHA.ACHREI_MOS_KEDOSHIM.name, PARSHA.EMOR.name,
         PARSHA.BEHAR_BECHUKOSAI.name, PARSHA.BAMIDBAR.name, PARSHA.NASSO.name, PARSHA.BEHAALOSCHA.name,
         PARSHA.SHLACH.name, PARSHA.KORACH.name, PARSHA.CHUKAS.name, PARSHA.BALAK.name, PARSHA.PINCHAS.name,
         PARSHA.MATOS_MASEI.name, PARSHA.DEVARIM.name, PARSHA.VAESCHANAN.name, PARSHA.EIKEV.name, PARSHA.REEH.name,
        ...
        [PARSHA.NONE.name, PARSHA.NONE.name, PARSHA.HAAZINU.name, PARSHA.NONE.name, PARSHA.NONE.name,
         ...
         PARSHA.SHLACH.name, PARSHA.KORACH.name, PARSHA.CHUKAS.name, PARSHA.BALAK.name, PARSHA.PINCHAS.name,
         PARSHA.MATOS_MASEI.name, PARSHA.DEVARIM.name, PARSHA.VAESCHANAN.name, PARSHA.EIKEV.name, PARSHA.REEH.name,
         PARSHA.SHOFTIM.name, PARSHA.KI_SEITZEI.name, PARSHA.KI_SAVO.name, PARSHA.NITZAVIM_VAYEILECH.name],
        [PARSHA.NONE.name, PARSHA.VAYEILECH.name, PARSHA.HAAZINU.name, PARSHA.NONE.name, PARSHA.BERESHIS.name,
         PARSHA.NOACH.name, PARSHA.LECH_LECHA.name, PARSHA.VAYERA.name, PARSHA.CHAYEI_SARA.name, PARSHA.TOLDOS.name,
         PARSHA.VAYETZEI.name, PARSHA.VAYISHLACH.name, PARSHA.VAYESHEV.name, PARSHA.MIKETZ.name, PARSHA.VAYIGASH.name,
         PARSHA.VAYECHI.name, PARSHA.SHEMOS.name, PARSHA.VAERA.name, PARSHA.BO.name, PARSHA.BESHALACH.name,
         PARSHA.YISRO.name, PARSHA.MISHPATIM.name, PARSHA.TERUMAH.name, PARSHA.TETZAVEH.name, PARSHA.KI_SISA.name,
         PARSHA.VAYAKHEL.name, PARSHA.PEKUDEI.name, PARSHA.VAYIKRA.name, PARSHA.TZAV.name, PARSHA.SHMINI.name,
         PARSHA.TAZRIA.name, PARSHA.METZORA.name, PARSHA.NONE.name, PARSHA.ACHREI_MOS.name, PARSHA.KEDOSHIM.name,
         PARSHA.EMOR.name, PARSHA.BEHAR.name, PARSHA.BECHUKOSAI.name, PARSHA.BAMIDBAR.name, PARSHA.NONE.name,
         PARSHA.NASSO.name, PARSHA.BEHAALOSCHA.name, PARSHA.SHLACH.name, PARSHA.KORACH.name, PARSHA.CHUKAS_BALAK.name,
         PARSHA.PINCHAS.name, PARSHA.MATOS_MASEI.name, PARSHA.DEVARIM.name, PARSHA.VAESCHANAN.name, PARSHA.EIKEV.name,
         PARSHA.REEH.name, PARSHA.SHOFTIM.name, PARSHA.KI_SEITZEI.name, PARSHA.KI_SAVO.name,
         PARSHA.NITZAVIM_VAYEILECH.name],
        [PARSHA.NONE.name, PARSHA.VAYEILECH.name, PARSHA.HAAZINU.name, PARSHA.NONE.name, PARSHA.BERESHIS.name,
         PARSHA.NOACH.name, PARSHA.LECH_LECHA.name, PARSHA.VAYERA.name, PARSHA.CHAYEI_SARA.name, PARSHA.TOLDOS.name,
         PARSHA.VAYETZEI.name, PARSHA.VAYISHLACH.name, PARSHA.VAYESHEV.name, PARSHA.MIKETZ.name, PARSHA.VAYIGASH.name,
         PARSHA.VAYECHI.name, PARSHA.SHEMOS.name, PARSHA.VAERA.name, PARSHA.BO.name, PARSHA.BESHALACH.name,
         PARSHA.YISRO.name, PARSHA.MISHPATIM.name, PARSHA.TERUMAH.name, PARSHA.TETZAVEH.name, PARSHA.KI_SISA.name,
         PARSHA.VAYAKHEL.name, PARSHA.PEKUDEI.name, PARSHA.VAYIKRA.name, PARSHA.TZAV.name, PARSHA.SHMINI.name,
         PARSHA.TAZRIA.name, PARSHA.METZORA.name, PARSHA.NONE.name, PARSHA.NONE.name, PARSHA.ACHREI_MOS.name,
         PARSHA.KEDOSHIM.name, PARSHA.EMOR.name, PARSHA.BEHAR.name, PARSHA.BECHUKOSAI.name, PARSHA.BAMIDBAR.name,
         PARSHA.NASSO.name, PARSHA.BEHAALOSCHA.name, PARSHA.SHLACH.name, PARSHA.KORACH.name, PARSHA.CHUKAS.name,
         PARSHA.BALAK.name, PARSHA.PINCHAS.name, PARSHA.MATOS_MASEI.name, PARSHA.DEVARIM.name, PARSHA.VAESCHANAN.name,
         PARSHA.EIKEV.name, PARSHA.REEH.name, PARSHA.SHOFTIM.name, PARSHA.KI_SEITZEI.name, PARSHA.KI_SAVO.name,
         PARSHA.NITZAVIM.name],
        [PARSHA.NONE.name, PARSHA.HAAZINU.name, PARSHA.NONE.name, PARSHA.NONE.name, PARSHA.BERESHIS.name,
         PARSHA.NOACH.name, PARSHA.LECH_LECHA.name, PARSHA.VAYERA.name, PARSHA.CHAYEI_SARA.name, PARSHA.TOLDOS.name,
         PARSHA.VAYETZEI.name, PARSHA.VAYISHLACH.name, PARSHA.VAYESHEV.name, PARSHA.MIKETZ.name, PARSHA.VAYIGASH.name,
         PARSHA.VAYECHI.name, PARSHA.SHEMOS.name, PARSHA.VAERA.name, PARSHA.BO.name, PARSHA.BESHALACH.name,
         PARSHA.YISRO.name, PARSHA.MISHPATIM.name, PARSHA.TERUMAH.name, PARSHA.TETZAVEH.name, PARSHA.KI_SISA.name,
         PARSHA.VAYAKHEL.name, PARSHA.PEKUDEI.name, PARSHA.VAYIKRA.name, PARSHA.TZAV.name, PARSHA.SHMINI.name,
         PARSHA.TAZRIA.name, PARSHA.METZORA.name, PARSHA.ACHREI_MOS.name, PARSHA.NONE.name, PARSHA.KEDOSHIM.name,
         PARSHA.EMOR.name, PARSHA.BEHAR.name, PARSHA.BECHUKOSAI.name, PARSHA.BAMIDBAR.name, PARSHA.NASSO.name,
         PARSHA.BEHAALOSCHA.name, PARSHA.SHLACH.name, PARSHA.KORACH.name, PARSHA.CHUKAS.name, PARSHA.BALAK.name,
         PARSHA.PINCHAS.name, PARSHA.MATOS.name, PARSHA.MASEI.name, PARSHA.DEVARIM.name, PARSHA.VAESCHANAN.name,
         PARSHA.EIKEV.name, PARSHA.REEH.name, PARSHA.SHOFTIM.name, PARSHA.KI_SEITZEI.name, PARSHA.KI_SAVO.name,
         PARSHA.NITZAVIM.name],
        [PARSHA.NONE.name, PARSHA.HAAZINU.name, PARSHA.NONE.name, PARSHA.NONE.name, PARSHA.BERESHIS.name,
         PARSHA.NOACH.name, PARSHA.LECH_LECHA.name, PARSHA.VAYERA.name, PARSHA.CHAYEI_SARA.name, PARSHA.TOLDOS.name,
        ...
        [PARSHA.NONE.name, PARSHA.NONE.name, PARSHA.HAAZINU.name, PARSHA.NONE.name, PARSHA.NONE.name,
         ...
         PARSHA.VAYIGASH.name, PARSHA.VAYECHI.name, PARSHA.SHEMOS.name, PARSHA.VAERA.name, PARSHA.BO.name,
         PARSHA.BESHALACH.name, PARSHA.YISRO.name, PARSHA.MISHPATIM.name, PARSHA.TERUMAH.name, PARSHA.TETZAVEH.name,
         PARSHA.KI_SISA.name, PARSHA.VAYAKHEL.name, PARSHA.PEKUDEI.name, PARSHA.VAYIKRA.name, PARSHA.TZAV.name,
         PARSHA.SHMINI.name, PARSHA.TAZRIA.name, PARSHA.METZORA.name, PARSHA.NONE.name, PARSHA.ACHREI_MOS.name,
         PARSHA.KEDOSHIM.name, PARSHA.EMOR.name, PARSHA.BEHAR.name, PARSHA.BECHUKOSAI.name, PARSHA.BAMIDBAR.name,
         PARSHA.NASSO.name, PARSHA.BEHAALOSCHA.name, PARSHA.SHLACH.name, PARSHA.KORACH.name, PARSHA.CHUKAS.name,
         PARSHA.BALAK.name, PARSHA.PINCHAS.name, PARSHA.MATOS_MASEI.name, PARSHA.DEVARIM.name, PARSHA.VAESCHANAN.name,
         PARSHA.EIKEV.name, PARSHA.REEH.name, PARSHA.SHOFTIM.name, PARSHA.KI_SEITZEI.name, PARSHA.KI_SAVO.name,
        ...
        [PARSHA.NONE.name, PARSHA.NONE.name, PARSHA.HAAZINU.name, PARSHA.NONE.name, PARSHA.NONE.name,
         ...
         PARSHA.SHMINI.name, PARSHA.TAZRIA.name, PARSHA.METZORA.name, PARSHA.NONE.name, PARSHA.ACHREI_MOS.name,
         PARSHA.KEDOSHIM.name, PARSHA.EMOR.name, PARSHA.BEHAR.name, PARSHA.BECHUKOSAI.name, PARSHA.BAMIDBAR.name,
         PARSHA.NONE.name, PARSHA.NASSO.name, PARSHA.BEHAALOSCHA.name, PARSHA.SHLACH.name, PARSHA.KORACH.name,
         PARSHA.CHUKAS_BALAK.name, PARSHA.PINCHAS.name, PARSHA.MATOS_MASEI.name, PARSHA.DEVARIM.name,
         PARSHA.VAESCHANAN.name, PARSHA.EIKEV.name, PARSHA.REEH.name, PARSHA.SHOFTIM.name, PARSHA.KI_SEITZEI.name,
         PARSHA.KI_SAVO.name, PARSHA.NITZAVIM_VAYEILECH.name],
        [PARSHA.NONE.name, PARSHA.VAYEILECH.name, PARSHA.HAAZINU.name, PARSHA.NONE.name, PARSHA.BERESHIS.name,
         PARSHA.NOACH.name, PARSHA.LECH_LECHA.name, PARSHA.VAYERA.name, PARSHA.CHAYEI_SARA.name, PARSHA.TOLDOS.name,
        ...
        [PARSHA.NONE.name, PARSHA.HAAZINU.name, PARSHA.NONE.name, PARSHA.NONE.name, PARSHA.BERESHIS.name,
         ...
         PARSHA.YISRO.name, PARSHA.MISHPATIM.name, PARSHA.TERUMAH.name, PARSHA.TETZAVEH.name, PARSHA.KI_SISA.name,
         PARSHA.VAYAKHEL_PEKUDEI.name, PARSHA.VAYIKRA.name, PARSHA.TZAV.name, PARSHA.NONE.name, PARSHA.SHMINI.name,
         PARSHA.TAZRIA_METZORA.name, PARSHA.ACHREI_MOS_KEDOSHIM.name, PARSHA.EMOR.name, PARSHA.BEHAR.name,
         PARSHA.BECHUKOSAI.name, PARSHA.BAMIDBAR.name, PARSHA.NASSO.name, PARSHA.BEHAALOSCHA.name, PARSHA.SHLACH.name,
         PARSHA.KORACH.name, PARSHA.CHUKAS.name, PARSHA.BALAK.name, PARSHA.PINCHAS.name, PARSHA.MATOS_MASEI.name,
         PARSHA.DEVARIM.name, PARSHA.VAESCHANAN.name, PARSHA.EIKEV.name, PARSHA.REEH.name, PARSHA.SHOFTIM.name,
         PARSHA.KI_SEITZEI.name, PARSHA.KI_SAVO.name, PARSHA.NITZAVIM.name],
        [PARSHA.NONE.name, PARSHA.VAYEILECH.name, PARSHA.HAAZINU.name, PARSHA.NONE.name, PARSHA.BERESHIS.name,
         PARSHA.NOACH.name, PARSHA.LECH_LECHA.name, PARSHA.VAYERA.name, PARSHA.CHAYEI_SARA.name, PARSHA.TOLDOS.name,
         PARSHA.VAYETZEI.name, PARSHA.VAYISHLACH.name, PARSHA.VAYESHEV.name, PARSHA.MIKETZ.name, PARSHA.VAYIGASH.name,
         PARSHA.VAYECHI.name, PARSHA.SHEMOS.name, PARSHA.VAERA.name, PARSHA.BO.name, PARSHA.BESHALACH.name,
